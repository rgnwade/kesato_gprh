...
class SuperAdminCourseListing extends Component {
  state = {
    column: [
      {
        name: "No",
            ...
            <div id="listing_">
              <div className="text-with-search d-flex justify-content-between align-items-center">
                <h3 className="text-title mb-0 text-uppercase">
                  <span className="text-uppercase">Liste de cours</span>{" "}
              ...
              <div className="listing-table">
                ...
                */}
                <DataTable
                  ...
                  rowLink="/superadmin/course/detail/"
                />
              </div>
...
export default SuperAdminCourseListing;
