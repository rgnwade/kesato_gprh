...
class SuperAdminCourseDetail extends Component {
  state = {
    data: [],
    notification: []
  };
  ...
  async componentDidMount() {
    const { data: result } = await http.get(
      config.apiEndPoint + "course/" + this.props.match.params.id
    );
  ...
  doSubmit = async () => {
    try {
      ...
      const result = await http.post(config.apiEndPoint + "course/update", {
        data: cleanData
      });
      if (result) {
        this.props.history.push("/superadmin/course/listing");
      } else {
    ...
    return (
      <React.Fragment>
        ...
        <section className="section-content container px-6">
          <h2 className="head-title text-uppercase">Session de cours</h2>
            ...
            <div className="box-listing-detail">
              <form className="my-form" onSubmit={this.handleSubmit}>
                ...
                <div className="row mx-min5">
                  <div className="col-md-9 pd-x-5">
                    <div className="form-group in-group">
                      <label className="text-bold">Désignation cours</label>
                      <input
                        type="text"
                  ...
                  <div className="col-md-3 pd-x-5">
                    <div className="row mx-min5">
                      <div className="col-md-6 pd-x-5 hide">
                        <div className="form-group in-group">
