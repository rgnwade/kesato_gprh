            ...
            <div className="col-md-8">
              <div className="header-menu">
                <ul className="d-flex justify-content-center">
                  <li>
                    <Link to="/superadmin/dashboard">tableau de bord</Link>
                  </li>
                  {/* <li>
                    <Link to="/superadmin/venue/listing">
                      gérer mes établissements
                    </Link>
                  </li>
                  <li>
                    <Link to="/superadmin/billing/listing">gérer mes factures</Link>
                  </li>
                  <li>
                    ...
                    <div className="row mx-min5">
                      ...
                      <div className="col-md-8 pd-x-5">
                        <div className="des-info">
                          ...
                          <p className="text-bold">Super Admin</p>
                          <p>
...
export default withRouter(connect(mapStateToProps)(HeaderSuperAdmin));
