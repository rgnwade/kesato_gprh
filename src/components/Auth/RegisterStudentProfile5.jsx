...
// TODO: This is the same as StudentCourseAdd, just a different title and return btn
class RegisterStudentProfile5 extends Component {
  state = {
    data: [],
    course: [],
    courseSelected: [],
...
export default RegisterStudentProfile5;
